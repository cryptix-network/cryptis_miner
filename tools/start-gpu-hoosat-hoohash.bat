...
REM GPU-only: hoosat + hoohash (OpenCL)
...
"%MINER_EXE%" --pool %POOL_URL% --wallet %WALLET% --worker %WORKER_NAME% --password %POOL_PASSWORD% --coin hoosat --hash hoohash --no-cpu %EXTRA_ARGS%
