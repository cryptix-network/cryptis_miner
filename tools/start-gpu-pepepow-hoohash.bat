...
REM GPU-only: pepepow + hoohash (OpenCL)
...
"%MINER_EXE%" --pool %POOL_URL% --wallet %WALLET% --worker %WORKER_NAME% --password %POOL_PASSWORD% --coin pepepow --hash hoohash --no-cpu %EXTRA_ARGS%
